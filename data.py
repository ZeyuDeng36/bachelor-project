...
for model, stats in models.items():
    ...
    averaged_rows.append([model, avg_train_loss, avg_train_acc, avg_val_loss, avg_val_acc])
...
with open(csv_filename, mode="w", newline="") as file:
    ...
    # Header row
    writer.writerow(["Model", "Average Train Loss", "Average Train Accuracy", "Average Validation Loss", "Average Validation Accuracy"])
