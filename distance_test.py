...
if __name__ == "__main__":
   ...
   # dataset, testset = initiate_dataset("CIFAR10", "resnet18")
    ...
    geo_medians = compute_class_geometric_medians(dataset, batch_size=128, eps=1e-5, max_iter=500)
    ...
    norm_scores = compute_normalized_distance_scores(dataset, geo_medians, batch_size=128, threshold=0.9, mode='max')
